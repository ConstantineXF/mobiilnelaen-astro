  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        '<h3>Ajakava pärast keeldumist</h3>',
        'Eitav otsus ei ole hinnang sinu isikule, vaid arvutus. Seda arvutust saab muuta, aga mitte samal päeval. Meie soovituslik järjekord on selline:',
        '<ul><li><strong>Esimesed 24 tundi.</strong> Küsi krediidiandjalt keeldumise põhjus. Kui otsus tugines andmekogu päringule, tuleb sulle tasuta teatada, millisest registrist päring tehti ja mis oli selle tulemus — nii näed, kas takistus on maksehäire, koormus või andmete lahknevus. Uut taotlust sel päeval mitte esitada.</li><li><strong>Esimene nädal.</strong> Küsi enda kohta käivad andmed välja: registripidaja ja iga krediidiandja on kohustatud andma sulle ülevaate sinu kohta töödeldavatest andmetest tasuta. Vale kirje tuleb lasta parandada, mitte üle elada.</li><li><strong>Üks kuni kolm kuud.</strong> Vähenda koormust: sulge kasutamata limiidid, tasu väiksemad järelmaksud, lase palgal laekuda samale kontole. Alles siis on uuel taotlusel teine sisend.</li><li><strong>Kolm kuni kuus kuud.</strong> Kui maksehäire sai tasutud, arvesta, et kirje ise kustub registrist alles kolm aastat pärast tasumist — vahepealsel ajal aitab pigem väiksem summa ja lühem periood kui uue pakkuja otsimine.</li></ul>',
        'Kui kõik tegevusloaga pakkujad ütlevad ei, on see sisuline vastus, mitte tõrge: praegune kuumakse ei mahu eelarvesse. Sellisel juhul on õige suund tasuta võlanõustamine kohaliku omavalitsuse sotsiaalosakonna kaudu, olemasoleva graafiku muutmine või kulu edasilükkamine — mitte litsentsita laenuandja, kelle üle järelevalvet ei ole. Tegevusloa olemasolu saab igaüks kontrollida <a href="https://www.fi.ee/et" target="_blank" rel="noopener noreferrer">Finantsinspektsiooni</a> registrist ja alternatiivina vaadata üle <a href="/vaikelaen">väikelaenu</a> tingimused, kus periood on pikem ja KKM madalam.',
      ],
    },
    {
      id: 'regulatsioon',
